...
function HeaderPhone(){
    return (
        <div className='headerPhone'>
            ...
            <div className='headerPhone__IconWrapper'>
                <Link to='/cart' className='headerPhone__Icon'>
                ...
                <div className='headerPhone__IconDot'>
                    2
                </div>
